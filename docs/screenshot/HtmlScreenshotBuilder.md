...
> [!TIP]
> See: [https://gotenberg.dev/docs/convert-with-chromium/screenshot-html#image-format](https://gotenberg.dev/docs/convert-with-chromium/screenshot-html#image-format)
