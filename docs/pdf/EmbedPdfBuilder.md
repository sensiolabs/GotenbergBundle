...
You may have the possibility to embed document to your PDF file.
...
> [!WARNING]
> As assets files, by default the PDF files and files to embed are fetch in the assets folder of
> your application.
