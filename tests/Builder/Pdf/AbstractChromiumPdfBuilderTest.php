...
class AbstractChromiumPdfBuilderTest extends AbstractBuilderTestCase
{
    ...
    {
        return new class($this->gotenbergClient, self::$assetBaseDirFormatter, $requestStack, $this->webhookConfigurationRegistry, true === $twig ? self::$twig : null) extends AbstractChromiumPdfBuilder {
