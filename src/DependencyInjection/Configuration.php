        ...
        $parent
            ->children()
                ...
                ->booleanNode('skip_network_idle_event')
                    ...
                    ->defaultNull()
                ->end()
                ->booleanNode('generate_tagged_pdf')
                    ->info('Define whether to generate tagged (accessible) PDF. - default false. https://gotenberg.dev/docs/routes#page-properties-chromium')
                    ->defaultNull()
                ->end()
