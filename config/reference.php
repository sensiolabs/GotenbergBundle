 ...
 *     assets_directory?: list<scalar|null>,
 *     version?: scalar|null, // Version of Gotenberg // Default: null
 *     http_client: scalar|null, // HTTP Client reference to use. (Must have a base_uri)
 *     request_context?: array{ // Override the request Gotenberg will make to call one of your routes.
 *         base_uri?: scalar|null, // Used only when using `->route()`. Overrides the guessed `base_url` from the request. May be useful in CLI.
 *     },
 *     controller_listener?: bool, // Enables the listener on kernel.view to stream GotenbergFileResult object. // Default: true
 *     webhook?: array<string, array{ // Default: []
 *         name?: scalar|null,
 *         success?: array{
 *             url?: scalar|null, // The URL to call.
 *             route?: mixed, // Route configuration.
 *             method?: "POST"|"PUT"|"PATCH", // HTTP method to use on that endpoint. // Default: null
 *         },
 *         error?: array{
 *             url?: scalar|null, // The URL to call.
 *             route?: mixed, // Route configuration.
 ...
 *     }>,
 *     default_options?: array{
 *         webhook?: scalar|null, // Webhook configuration name.
 *         pdf?: array{
 *             convert?: array{
 *                 webhook?: string|array{
 *                     config_name?: scalar|null,
 *                     success?: array{
 *                         url?: scalar|null,
 *                         route?: mixed,
 ...
 *                 pdf_format?: "PDF/A-1b"|"PDF/A-2b"|"PDF/A-3b",
 *                 flatten?: bool,
 ...
 *                     extra_http_headers?: array<string, mixed>,
 *                 },
 *                 owner_password?: scalar|null,
 *                 user_password?: scalar|null,
 *                 download_from?: list<array{ // Default: []
 *                     url: scalar|null,
 *                     extraHttpHeaders?: array<string, array{ // Default: []
 *                         name: scalar|null,
 ...
 *                 },
 *                 split_unify?: bool,
 *                 split_span?: scalar|null,
 *                 split_mode?: "intervals"|"pages",
 *                 pdf_universal_access?: bool,
 *                 pdf_format?: "PDF/A-1b"|"PDF/A-2b"|"PDF/A-3b",
 *                 metadata?: array{
 *                     Author?: scalar|null,
 *                     Copyright?: scalar|null,
 *                     CreationDate?: scalar|null,
 *                     Creator?: scalar|null,
 *                     Keywords?: scalar|null,
 *                     Marked?: bool,
 *                     ModDate?: scalar|null,
 *                     PDFVersion?: scalar|null,
 *                     Producer?: scalar|null,
 *                     Subject?: scalar|null,
 *                     Title?: scalar|null,
 ...
 *                     }>,
 *                 }>,
 *                 wait_for_expression?: scalar|null,
 *                 wait_delay?: scalar|null,
 *                 skip_network_idle_event?: bool,
 *                 generate_tagged_pdf?: bool,
 *                 native_page_ranges?: scalar|null,
 *                 scale?: float,
 *                 landscape?: bool,
 ...
 *                 margin_right?: scalar|null,
 *                 margin_left?: scalar|null,
 *                 margin_bottom?: scalar|null,
 *                 margin_top?: scalar|null,
 *                 paper_standard_size?: "letter"|"legal"|"tabloid"|"ledger"|"A0"|"A1"|"A2"|"A3"|"A4"|"A5"|"A6",
 *                 paper_height?: scalar|null,
 *                 paper_width?: scalar|null,
 *                 single_page?: bool,
 *                 fail_on_console_exceptions?: bool,
 *                 fail_on_resource_loading_failed?: bool,
 *                 fail_on_resource_http_status_codes?: list<int>,
 *                 fail_on_http_status_codes?: list<int>,
 *                 emulated_media_type?: "print"|"screen",
 *                 extra_http_headers?: array<string, mixed>,
 *                 user_agent?: scalar|null,
 ...
 *                 },
 *                 update_indexes?: bool,
 *                 max_image_resolution?: 75|150|300|600|1200,
 ...
 *                 export_notes?: bool,
 *                 export_placeholders?: bool,
 *                 export_bookmarks_to_pdf_destination?: bool,
 *                 do_not_export_bookmarks?: bool,
 *                 allow_duplicate_field_names?: bool,
 *                 do_not_export_form_fields?: bool,
 *                 native_page_ranges?: scalar|null,
 *                 landscape?: bool,
